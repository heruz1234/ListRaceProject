...
export default function WorkSection({data,key}) {
  return (
    <div>
       <div  key={key} className='ml-[-30px] mt-3 md:mt-0 md:ml-0 py-[50px] px-[35px] border w-[350px] hover:bg-red-400 hover:text-white rounded-xl shadow-lg shadow-gray-500/70 '>
