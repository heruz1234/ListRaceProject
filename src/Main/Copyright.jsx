...
export default function Copyright() {
  return (
    <div className='text-gray-400 flex items-center justify-between w-[80%] m-auto py-10 border border-x-0 border-t-0'>
        <h2>©Copyright. Designed And Developed By Themesine</h2>
        <div className='flex justify-between w-[35%]'>
            <p className='flex hover:text-[red]'><IoCallOutline className='mt-2'/><span className='pl-2'> +1 (222) 777 8888</span></p>
